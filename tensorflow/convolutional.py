...
def extract_labels_json(filename, num_images):
    """Extract the labels into a 1-hot matrix [image index, label index]."""
    print 'Extracting', filename
...
def main(argv=None):  # pylint: disable=unused-argument
    if FLAGS.self_test:
        ...
        # Get the data.
        train_data_filename = '/usr/lib/python2.7/site-packages/tensorflow/models/image/mnist/train-labels-idx1-ubyte.json' 
        test_data_filename = '/usr/lib/python2.7/site-packages/tensorflow/models/image/mnist/eval-labels-idx1-ubyte.json'

        # Extract it into numpy arrays.
	
        train_data, train_labels = extract_data_json(train_data_filename, 1)
	print(train_data)
        test_data, test_labels = extract_data_json(test_data_filename, 1)
	...
	saver = tf.train.Saver()
        ...
        save_path = saver.save(s, "/tmp/poker.model")
